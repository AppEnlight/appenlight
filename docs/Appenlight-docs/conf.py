...
project = u'RhodeCode Appenlight %s ' % _get_version()
copyright = u'2014-{now.year}, RhodeCode GmbH'.format(
...
htmlhelp_basename = 'rhodecode-appenlight'
...
latex_documents = [
  ('index', 'RhodeCodeAppenlight.tex', u'RhodeCode Appenlight',
...
man_pages = [
    ('rhodecode-enterprise', 'rhodecodeenterprise', u'RhodeCode Enterprise',
     [u'RhodeCode GmbH'], 1)
]
...
texinfo_documents = [
  ('rhodecode-enterprise', 'RhodeCodeEnterprise', u'RhodeCode Enterprise',
   u'Brian Butler', 'RhodeCodeEnterprise', 'One line description of project.',
   'Miscellaneous'),
]

...
def upgrade():
    ...
    op.add_column('users', sa.Column('default_report_sort', sa.Unicode(20), nullable=False, server_default="newest"))
    ...
    op.add_column('users', sa.Column('registration_ip', sa.Unicode(40), nullable=False, server_default=''))
    ...
    op.create_table(
        ...
        sa.Column('channel_validated', sa.Boolean, nullable=False, server_default='False'),
        sa.Column('send_alerts', sa.Boolean, nullable=False, server_default='True'),
        sa.Column('notify_only_first', sa.Boolean, nullable=False, server_default='False'),
        ...
        sa.Column('integration_id', sa.Integer,
                  sa.ForeignKey('integrations.id', onupdate='cascade',
                                ondelete='cascade')),
    )
    op.create_unique_constraint('uq_alert_channels', 'alert_channels',
    ...
    op.create_table(
        ...
        sa.Column('default_grouping', sa.Unicode(20), nullable=False, server_default='url_type'),
        sa.Column('public_key', sa.Unicode(32), nullable=False, index=True),
        sa.Column('error_report_threshold', sa.Integer(), server_default='10', nullable=False),
        sa.Column('slow_report_threshold', sa.Integer(), server_default='10', nullable=False),
        sa.Column('apdex_threshold', sa.Float(), server_default='0.7', nullable=False),
        sa.Column('allow_permanent_storage', sa.Boolean(), server_default="false", nullable=False),
    )
    op.create_unique_constraint(None, 'applications',
                                ["public_key"])
    op.create_unique_constraint(None, 'applications',
                                ["api_key"])
    ...
    op.create_table(
        ...
        sa.Column('first_timestamp', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        ...
        sa.Column('triggered_postprocesses_ids', sa.dialects.postgresql.JSON, nullable=False, server_default="[]"),
    ...
    op.create_table(
        'reports',
        sa.Column('id', sa.types.BigInteger, primary_key=True),
        sa.Column('group_id', sa.types.BigInteger,
                  sa.ForeignKey('reports_groups.id', onupdate='cascade',
                                ondelete='cascade'), nullable=False, index=True),
        sa.Column('resource_id', sa.Integer, nullable=False, index=True),
        sa.Column('report_type', sa.Integer, nullable=False, server_default="0"),
        sa.Column('error', sa.UnicodeText, nullable=False, server_default=""),
        sa.Column('extra', sa.dialects.postgresql.JSON, nullable=False, server_default="{}"),
        sa.Column('request', sa.dialects.postgresql.JSON, nullable=False, server_default="{}"),
        ...
        sa.Column('request_stats', sa.dialects.postgresql.JSON, nullable=False, server_default="{}"),
        sa.Column('traceback', sa.dialects.postgresql.JSON, nullable=False, server_default="{}"),
        ...
        sa.Column('report_group_time', sa.DateTime, index=True, nullable=False, server_default=sa.func.now()),
    ...
    op.create_index(None, 'reports',
                    [sa.text("(tags ->> 'server_name')")])
    op.create_index(None, 'reports',
                    [sa.text("(tags ->> 'view_name')")])
    ...
    op.create_table(
        ...
        sa.Column('occurences', sa.Integer, nullable=False, server_default='0', index=True),
        sa.Column('owner_user_id', sa.Integer),
        sa.Column('type', sa.Integer, index=True, nullable=False),
        sa.Column('duration', sa.Float(), server_default='0'),
        sa.Column('server_name', sa.Unicode(128),
                  server_default=''),
        sa.Column('view_name', sa.Unicode(128),
                  server_default=''),
        sa.Column('id', sa.BigInteger(), nullable=False, primary_key=True),
    )
    op.create_index('ix_reports_stats_start_interval_group_id', 'reports_stats',
                    ["start_interval", "group_id"])

    op.create_table(
        'slow_calls',
        sa.Column('id', sa.types.BigInteger, primary_key=True),
        sa.Column('report_id', sa.types.BigInteger, sa.ForeignKey('reports.id', onupdate='cascade', ondelete='cascade'),
                  nullable=False, index=True),
        sa.Column('duration', sa.Float(), nullable=False, server_default="0", index=True),
    ...
    op.create_table(
        ...
        sa.Column('resource_id', sa.Integer,
                  sa.ForeignKey('resources.resource_id', onupdate='cascade',
                                ondelete='cascade')),
        sa.Column('first_timestamp', sa.DateTime, nullable=False, server_default=sa.func.now()),
        sa.Column('last_timestamp', sa.DateTime, nullable=False, server_default=sa.func.now()),
    ...
    op.create_table(
        ...
        sa.Column('value', sa.dialects.postgresql.JSON,
                  server_default="{}")
    )
    ...
    version_table = sa.table('rc_versions',

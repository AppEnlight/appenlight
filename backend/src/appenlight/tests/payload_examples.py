             ...
             {"cline": "return foo_bar_baz(1,2,3)",
              ...
              "vars": [["a_list",
                       ...
                       ["b",
                        {1: "2", "ccc": "ddd", "1": "a"}],
                       ["obj",
                        "<object object at 0x7f0030853dc0>"]]},
...
JS_PAYLOAD = {
    "client": "javascript", "language": "javascript",
    "error_type": "ReferenceError: non_existant_var is not defined",
    "occurences": 1, "priority": 5, "server": "jstest.appenlight",
    "http_status": 500, "report_details": [{
...
SENTRY_JS_PAYLOAD_7 = {
    "project": "sentry", "logger": "javascript",
    "platform": "javascript", "request": {"headers": {
        "User-Agent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.111 Safari/537.36"},
        "url": "http://localhost:6543/test/js_error#/"},
    "exception": {"values": [{"type": "ReferenceError",
...
SENTRY_LOG_PAYLOAD_7 = {
    "project": "sentry", "sentry.interfaces.Message": {
        "message": "TEST from django logging", "params": []},
    "server_name": "ergo-virtual-machine",
    "culprit": "testlogger in index",
    "extra": {"thread": 139723601139456, "process": 24645,
              "sys.argv": ["'manage.py'", "'runserver'"],
              "price": 6, "threadName": "'Thread-1'",
              "filename": "'views.py'",
              "processName": "'MainProcess'",
              "tag": "'extra'", "dupa": True, "lineno": 22,
    ...
    "timestamp": now.strftime('%Y-%m-%dT%H:%M:%SZ'),
    "tags": {"site": "example.com"},
    "modules": {"python": "2.7.6", "raven": "5.9.2",
                "django": "1.7.1"}, "time_spent": None,
    "platform": "python", "release": "test",
    "logger": "testlogger", "level": 50,
